    ...
    tabItems(
      ...
      tabItem(tabName = "_sim",
          tabsetPanel(id = "navbar",
            ...
            tabPanel("Saturation",
                     shiny::br(),
                     shiny::plotOutput("plot_saturation", height = 600) ),
            tabPanel("Column",
                     shiny::br(),
            ...
            tabPanel("Fluid Correlations", id = "CORRSENS", value = "CORRSENS",
                    ...
                    shiny::br(),
                    shiny::h5("Pb / Bo / Density Correlations:"),
                    shiny::p("0       Glaso"),
                    shiny::p("1       Standing"),
                    shiny::p("2       Lasater"),
                    shiny::p("3       VazquezBeggs"),
                    shiny::p("4       Petroskyetal"),
                    shiny::p("5       AlMarhoun"),
                    shiny::p("6       DeGhettoetalHeavyoil"),
                    shiny::br(),
                    shiny::h5("Viscosity Correlations:"),
                    shiny::p("0       Bealetal"),
                    shiny::p("1       Beggsetal"),
                    shiny::p("2       Petroskyetal"),
                    shiny::p("3       EgbogahetalHeavyOil"),
                    shiny::p("4       BergmanSutton"),
                    shiny::p("5       DeGhettoetalHeavyOil")
                    )
            )
          ),
      #-------------------------------------------------------------------------------
